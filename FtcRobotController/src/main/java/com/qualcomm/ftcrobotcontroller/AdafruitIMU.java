...
public class AdafruitIMU implements HardwareDevice, I2cController.I2cPortReadyCallback{
  ...
  */
   ...
   */
            ...
            tempQuatRoll = Math.atan2(2.0*(quaternionVector[1]*quaternionVector[0]+quaternionVector[3]*quaternionVector[2]),
                    1.0-2.0*(Math.pow(quaternionVector[2],2)+Math.pow(quaternionVector[1],2))) * 180.0 / Math.PI;
